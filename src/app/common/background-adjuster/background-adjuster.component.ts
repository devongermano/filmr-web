import { Component, OnInit, ViewEncapsulation, Input, AfterViewInit, Renderer2, OnDestroy } from '@angular/core';

@Component({
  selector: 'app-background-adjuster',
  templateUrl: './background-adjuster.component.html',
  styleUrls: ['./background-adjuster.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BackgroundAdjusterComponent implements OnInit, AfterViewInit, OnDestroy {

  @Input('backgroundStyle') backgroundStyle: { [styleName: string]: string } | CSSStyleDeclaration;
  ...
  ngAfterViewInit(): void {
    this.setStyles(".background-adjuster", this.backgroundStyle);
    this.renderer.addClass(document.body, 'background-adjuster');
  }

  ngOnDestroy(): void {
    this.renderer.removeClass(document.body, 'background-adjuster');
  }
